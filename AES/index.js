...
(lib.SixBitLow = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		this.setValue = (function(bitArray) {
            ...
            if (i === 0 || i === 5) {
                this["field" + i].color = "#8b0000"; // غيرت لون اول واخر بيت للاحمر عشانهم زياده
            }
			}
		}).bind(this);
	}
...
(lib.DESVisualizer = function(mode,startPosition,loop) {
	...
	this.frame_2 = function() {
		...
		this.titleTxt.text = (this.globalData.isEncryption) ? "AES Encryption" : "AES Decryption";
	...
	this.frame_5 = function() {
		...
		function updateRound() {
			this.globalData.roundIndex = this.roundSelector.getRoundIndex();
			this.desRoundTitleTxt.text = "AES Round " + (this.globalData.roundIndex + 1);
	...
	// DES
	this.text = new cjs.Text("Advanced Encryption Standard (AES)", "normal 400 48px 'Open Sans'", "#231a6f");
	this.text.textAlign = "center";
	...
	this.titleTxt = new cjs.Text("AES Encryption", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	// DES Rounds
	this.desRoundTitleTxt = new cjs.Text("AES Round 1", "normal 400 48px 'Open Sans'", "#231a6f");
