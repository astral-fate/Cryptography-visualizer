...
///////////////////////ارجعيييي له النكست يشتغل اوتوماتيك

(lib.stepForwardBtn = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.text = new cjs.Text("Next", "18px 'Arial'", "#333333");// غيرت الاسم لنكست بس
...
(lib.stepBackwardBtn = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.text = new cjs.Text("Back", "18px 'Arial'", "#333333");// غيرت الاسم لباك بس
	this.text.lineHeight = 22;
	this.text.parent = this;
...
(lib.SixBitLow = function(mode, startPosition, loop) {
 ...
 /*    this.addEventListener("mouseover", handleMouseOver.bind(this));
    ...
    this.frame_0 = function() {
        this.setValue = function(bitArray) {
            for (let i = 0; i < 6; i++) {
                ...
                if (i === 0 || i === 5) {
                    this["field" + i].color = "#8b0000"; // Change color for the first and last bit to red
                }
            }
        };
    }
	...
	this.shape.graphics.f().s("#000000").ss(1,0,1).p("AAAiLIAAEX");// البوكس حق الارقام الاربعه
	this.shape.setTransform(77.2,14);

	this.shape_1 = new cjs.Shape();
	// هذي الزياده خليتها تصير
	...
	/* function showTooltip(message, x, y) {
		...
		// Add temporary styling for visibility testing
		tooltip.style.backgroundColor = "red"; // or any color you can easily notice
		tooltip.style.border = "1px solid blue"; // or any border style
...
// Function to set values when the mouse is over
function handleMouseOver(event) {
    console.log("Mouse over");
    var stage = this.getStage();
    if (stage) {
        var pt = this.localToGlobal(event.localX, event.localY);
        showTooltip("Hello! This is the SixBitLow MovieClip.", pt.x, pt.y);
    }
}
    // Function to set values when the mouse is out
    function handleMouseOut() {
        console.log("Mouse out");
		hideTooltip();
        // You can add additional code to change the appearance or behavior when the mouse is out
    }

    // Function to handle click events
    function handleClick() {
        console.log("Clicked");
        // You can add additional code to handle the click event
    };
 */
    // actions tween
    this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1));
...
(lib.sBoxRow = function(mode,startPosition,loop) {
	...
	// Layer 2
	// هذا الاس بوكس التكست اللي وسط التيبل مو اللي فوق 
	...
	this.field0.parent = this;
	this.field0.color = "black";//يغير لون الكلام بالصف + انا اللي اضفته بشوف شيطلع
...
(lib.SBoxRowHighlight = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,0,0.498)").s().p("EhHTACoIAAlQMCOnAAAIAAFQg");// لون اصفر
...
(lib.SBoxColumnHighlight = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,0,0,0.3)").s().p("AkTTPMAAAgmdIInAAMAAAAmdg");// غيرت لون العامود للاحمر
...
(lib.Arrow = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231a6f").s().p("AAAhHIkPDfIgXg8IEmjzIEnDzIgXA8g");//هنا اللون من ازرق فاتح للون الكحلي حقنا
...
(lib.SBoxes = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("plaintext Bits", "normal 400 16px 'Open Sans'");
	this.text_1.textAlign = "center";
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231a6f").s().p("");
...
(lib.roundSelector = function(mode,startPosition,loop) {
	...
	// round label
	this.text = new cjs.Text("Round:", "normal 400 18px 'Open Sans'", "#ffffff");//لون التكست حق الراوند 
	...
	// background
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231a6f").s("#ffffff").ss(2,1,1).rr(-118.65,-20,237.3,40,4);//هنا لون البوكس حق الراوند 
...
(lib.ReverseOrderDiagramPortion = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#231a6f").s().p("AufClIAAjMIACAAIAAgNIgCAAIAAhxIc/AAIAAFKg");
...
(lib.Permutation = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.showPermutation = function (inputData, numInputColumns, permutationMapping, numMappingColumns, outputData, inputLabel, mappingLabel, outputLabel) {
			...
			var inputIndex = 0;
			var delay = 500; // Delay in milliseconds between showing each input element
		
			function animateInput() {
				if (inputIndex < inputData.length) {
					inputFields[inputIndex].visible = true;
					inputIndex++;
					setTimeout(animateInput, delay);
				}
			}
...
(lib.manglerExpansion = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231a6f").s().p("AueGUIAAgfIgBAAIAAngIACAAIAAggIgCAAIAAkIIc+AAIAAMDIABAAIAAAkg");
...
(lib.HexDisplay = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		hideBinary.bind(this)();// هنا شلون الباينري لما نضغطه يطلع ويختفي
...
(lib.DESRounds = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.setData = (function(cryptoObject, roundIndex) {
			...
			this.leftInitialDsp.setValue(round.leftInitial);//hereeeeeeeeeeee
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231a6f").s().p("AueI1IAAgsIgBAAIAAqfIACAAIAAgtIgCAAIAAlxIc+AAIAAQ2IABAAIAAAzg");
...
(lib.DESOverview = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231a6f").s().p("AYxJMIAApRIAAiCIADAAIAAgxIgDAAIAAmOIOgAAIOgAAIAAJwIAAIigEg1wAJHIAAm/IAAkTIAAgBIACAAIAAgxIgCAAIAAmOIc/AAIAAJdIAAI1g");
...
(lib.DESInternal = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.straightThrough.showKeyTable.addEventListener("mouseover", showInOrderKeyTable.bind(this));////هذي المربعه اللي تطلع الكي تيبل S
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#231a6f").s().p("AxAcoIAArUIACAAIAAgPIACgBIgCgBIAAggIgCAAIAAmOIc/AAIAASTgEAoLAQlIAArUIACAAIAAgxIgCAAIAAmNIc/AAIAASSgAxAqUIAArUIACAAIAAgxIgCAAIAAmOIOYAAIOnAAIAASTgEhFJgKUIAArUIACAAIAAgxIgCAAIAAmOIOLAAIO0AAIAASTg");
...
(lib.KeyGenRounds = function(mode,startPosition,loop) {
	...
	this.text_20 = new cjs.Text("Number of shift left", "normal 400 16px 'Open Sans'"); // هنا غيلات الاسم للشفتينق اسهل
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231a6f").s().p("AAxJKIvQAAIAArUIACAAIAAgxIgCAAIAAmNIPQAAINvAAIAASSg");
...
(lib.KeyGen = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#231a6f").s().p("A6RJNItuAAIAArTIACAAIAAgwIgCAAIAAmPIc/AAIAASSgAZlJGIukAAIAArUIACAAIAAgwIgCAAIAAmPIOkAAIOcAAIAAI5IAAJag");
...
(lib.DESVisualizer = function(mode,startPosition,loop) {
	...
	this.frame_1 = function() {
		...
		function gotoEncryption() {
			this.globalData.isEncryption = true;
			this.gotoAndStop("Internal");/// كل البوكسات اللي داخل الانكربشنٍ
	...
	// DES
	this.text = new cjs.Text("Data Encryption Standard (DES)", "normal 400 48px 'Open Sans'", "#231a6f");
	this.text.textAlign = "center";
	...
	this.titleTxt = new cjs.Text("DES Encryption", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	this.text_1 = new cjs.Text("Round Key Generation", "normal 400 48px 'Open Sans'", "#231a6f");
	this.text_1.textAlign = "center";
	...
	this.keyRoundsTitleTxt = new cjs.Text("Key Round", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	// DES Rounds
	this.desRoundTitleTxt = new cjs.Text("DES Round 1", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	// Mangler Title
	this.manglerTitleTxt = new cjs.Text("Mangler (DES Round 1)", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	// S-Box Title
	this.sBoxTitleTxt = new cjs.Text("S-Box 1 (DES Round 1)", "normal 400 48px 'Open Sans'", "#231a6f");
	...
	// Permutation Title
	this.permutationTitleTxt = new cjs.Text("Permutation", "normal 400 48px 'Open Sans'", "#231a6f");
